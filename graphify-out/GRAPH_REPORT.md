...
## Corpus Check
- 56 files · ~18,028 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 363 nodes · 624 edges · 26 communities (24 shown, 2 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 1 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `90a39908`
...
Cohesion: 0.07
Nodes (39): downloadBlob(), exportPptx(), generateContent(), FreeformCanvasHandle, GeneratePanel(), Props, resolve(), Updater (+31 more)
...
Cohesion: 0.08
Nodes (35): ElementInspector(), Props, CanvasElement, ClickClearState, clientToCanvasPct(), DragState, FreeformCanvas, MarqueeState (+27 more)
...
## Knowledge Gaps
- **102 isolated node(s):** `DEFAULT_CONFIG_PATH`, `WanxTaskResponse`, `FALLBACK_PNG`, `SlideChart`, `SlideColumn` (+97 more)
...
- **Why does `PptService` connect `Community 1` to `Community 5`?**
  _High betweenness centrality (0.234) - this node is a cross-community bridge._
- **Why does `resolve()` connect `Community 0` to `Community 1`?**
  _High betweenness centrality (0.231) - this node is a cross-community bridge._
- **Why does `FileLogger` connect `Community 10` to `Community 5`?**
